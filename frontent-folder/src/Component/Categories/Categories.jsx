...
const Categories = () => {
  return (
    <div className='categories' id='categories'> 
      ...
      <h1  data-aos = "fade-right">Appliances That Matter</h1>
      <p  data-aos = "fade-left">Fischer is known for manufacturing cooling and hot water appliances. Our geysers are found installed in most 
